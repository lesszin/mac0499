...
@app.route('/api/analise-espacial/matriculas')
def get_spatial_analysis_enrollments():
    try:
        modalidade_map = {
            "total": 'm."QT_MAT_BAS"',
            "creche": 'm."QT_MAT_INF_CRE"',
            "pre_escola": 'm."QT_MAT_INF_PRE"',
            "fund_ai": 'm."QT_MAT_FUND_AI"',
            "fund_af": 'm."QT_MAT_FUND_AF"',
            "medio": 'm."QT_MAT_MED"',
            "medio_int": 'm."QT_MAT_PROF"',
            "eja_fund": 'm."QT_MAT_EJA_FUND"',
            "eja_med": 'm."QT_MAT_EJA_MED"',
            "tecnico": 'm."QT_MAT_PROF"'
        }

        genero_map = {
            "masculino": 'm."QT_MAT_BAS_MASC"',
            "feminino": 'm."QT_MAT_BAS_FEM"'
        }

        raca_cor_map = {
            "nd": 'm."QT_MAT_BAS_ND"',
            "branca": 'm."QT_MAT_BAS_BRANCA"',
            "preta": 'm."QT_MAT_BAS_PRETA"',
            "parda": 'm."QT_MAT_BAS_PARDA"',
            "amarela": 'm."QT_MAT_BAS_AMARELA"',
            "indigena": 'm."QT_MAT_BAS_INDIGENA"'
        }
        ...
        if tipo not in (
            ...
            return jsonify({
                "erro": "Tipo de indicador inválido."
            }), 400
