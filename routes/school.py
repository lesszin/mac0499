...
@school_bp.route('/api/busca/<string:text_query>')
...
@school_bp.route('/api/ficha/<int:school_code>')
...
@school_bp.route('/api/escolas-mapa')
def get_map_schools():
    try:
        dependencia_map = {
            "federal": 1,
...
@school_bp.route('/api/escola/<int:school_code>/ficha')
...
@school_bp.route('/escola/<int:school_code>')
def render_details(school_code):
    return render_template('details.html', codigo=school_code)

@school_bp.route('/api/escola-localizacao/<int:school_code>')
